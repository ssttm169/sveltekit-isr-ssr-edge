...
function createLinkIndex() {
  const { subscribe: subscribe2, set, update } = writable(0);
  return {
    subscribe: subscribe2,
...
var LinkDataState, LinkIndexState;
var init_stores = __esm({
  ".svelte-kit/output/server/chunks/stores.js"() {
    init_index2();
    LinkDataState = createLink();
    LinkIndexState = createLinkIndex();
  }
});
...
var LinkForm, WindowContent, Layout;
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    init_index3();
    init_stores();
    LinkForm = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
<button class="${"button_icon-button__BC_Ca home_chat-input-send__rsJfH clickable"}" role="${"button"}" style="${"position:relative;left:auto;right:auto;bottom:auto;"}"><div class="${"button_icon-button-icon__qlUH3 no-dark"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" xmlns:xlink="${"http://www.w3.org/1999/xlink"}" width="${"16"}" height="${"16"}" fill="${"none"}"><defs><path id="${"send-white_svg__a"}" d="${"M0 0h16v16H0z"}"></path></defs><g><mask id="${"send-white_svg__b"}" fill="${"#fff"}"><use xlink:href="${"#send-white_svg__a"}"></use></mask><g mask="${"url(#send-white_svg__b)"}"><path transform="${"translate(1.333 2)"}" d="${"M0 4.71 6.67 6l1.67 6.67L12.67 0 0 4.71Z"}" style="${"stroke: rgb(255, 255, 255); stroke-width: 1.33333; stroke-opacity: 1; stroke-dasharray: 0, 0;"}"></path><path transform="${"translate(8.003 6.117)"}" d="${"M0 1.89 1.89 0"}" style="${"stroke: rgb(255, 255, 255); stroke-width: 1.33333; stroke-opacity: 1; stroke-dasharray: 0, 0;"}"></path></g></g></svg></div>
    ...
    WindowContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let currentFormData;
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    file = "_app/immutable/components/pages/_layout.svelte-e53f2d03.js";
    imports = ["_app/immutable/components/pages/_layout.svelte-e53f2d03.js", "_app/immutable/chunks/index-8e1005e2.js", "_app/immutable/chunks/stores-06992c39.js", "_app/immutable/chunks/index-43523b37.js"];
    stylesheets = ["_app/immutable/assets/_layout-f9b187a6.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    file2 = "_app/immutable/components/error.svelte-e8ebc2ba.js";
    imports2 = ["_app/immutable/components/error.svelte-e8ebc2ba.js", "_app/immutable/chunks/index-8e1005e2.js", "_app/immutable/chunks/singletons-08507998.js", "_app/immutable/chunks/index-43523b37.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});

// .svelte-kit/output/server/entries/pages/edge/_page.server.js
...
// .svelte-kit/output/server/entries/pages/edge/_page.svelte.js
  ...
  ".svelte-kit/output/server/entries/pages/edge/_page.svelte.js"() {
    ...
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.data === void 0 && $$bindings.data && data !== void 0)
        $$bindings.data(data);
      return `<div><div class="${"font-bold text-2xl mb-4"}">Edge Functions</div>
	<div class="${"opacity-80 mb-4"}">This page is returning the date from a SvelteKit page endpoint with edge configuration
		...
		the user. Learn more about edge functions <a class="${"text-blue-400 hover:text-blue-400"}" href="${"https://vercel.com/docs/concepts/functions/edge-functions"}" target="${"_blank"}">here</a>.
	</div>
	<div class="${"opacity-80 mb-4"}">This page endpoint runs on the edge, and returns the current date and time. Notice each time you
		refresh the page, the endpoint runs again and the time is updated.
	</div>
	<div class="${"bg-zinc-900/60 rounded-md p-6 shadow-md mb-4 shadow-zinc-700/30"}"><div class="${"mb-2 text-sm uppercase text-white/60"}">Current Date:</div>
		<div class="${"text-2xl"}">${escape(data.generatedAt)}</div></div></div>`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    file3 = "_app/immutable/components/pages/edge/_page.svelte-0f351e5f.js";
    imports3 = ["_app/immutable/components/pages/edge/_page.svelte-0f351e5f.js", "_app/immutable/chunks/index-8e1005e2.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});
